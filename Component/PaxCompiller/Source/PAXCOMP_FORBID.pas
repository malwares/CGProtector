...
constructor TForbiddenPropList.Create;
begin
  inherited;
  L := TList.Create;
end;

destructor TForbiddenPropList.Destroy;
begin
  Clear;
  L.Free;
  inherited;
...
procedure TForbiddenPropList.Clear;
var
  I: Integer;
begin
  for I:=0 to L.Count - 1 do
...
function TForbiddenPropList.GetCount: Integer;
begin
  result := L.Count;
end;
