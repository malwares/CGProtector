...
begin
  ...
  begin
    ...
    if not (csDesigning in ComponentState) and Glow and Assigned(FBrGlowTimer) and FAdvOfficeTabs[TabIndex].Glow and (FAdvOfficeTabs[TabIndex].GlowColor <> clNone) then
    begin
    ...
    begin
      ...
      begin
        ...
        DrawVistaGradient(bmp.Canvas, Rect(0, 0, R.Right - R.Left, R.Bottom-R.Top),GradColor, GradColorTo, GradColorMirror, GradColorMirrorTo, PenColor,
          GradU, GradB, '', {Canvas.}Font, Layout, Enabled, False, FAntiAlias, True{FCurrentOfficeTabSetStyler.RoundEdges}, FAdvOfficeTabs.Items[TabIndex].Progress, RotateTabLeftRight, TabPosition);
      ...
      begin
        case TabPosition of
          ...
          begin
            ...
            //--- Draw 3D effect
            if not FAdvOfficeTabs.Items[TabIndex].Progress.Visible then
            begin
            ...
            if (HighLightClr <> clNone) and not (FAdvOfficeTabs.Items[TabIndex].Progress.Visible and ShowNonSelectedTabs and (TabIndex <> ActiveTabIndex)) then
            begin
...
begin
  ...
  FClosedListButton.Width := TABBUTTON_SIZE;
  FClosedListButton.Height := TABBUTTON_SIZE;
