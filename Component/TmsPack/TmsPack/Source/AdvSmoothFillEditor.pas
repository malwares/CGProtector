...
procedure TAdvSmoothFillEditorForm.FormCreate(Sender: TObject);
begin
  ...
  AdvSmoothFillPreview2.Width := 65;
  AdvSmoothFillPreview2.Height := 65;

  AdvSmoothFillPreview3 := TAdvSmoothFillPreview.Create(GroupBox2);
  AdvSmoothFillPreview3.Parent := GroupBox2;
  AdvSmoothFillPreview3.Left := 374;
  AdvSmoothFillPreview3.Top := 18;
  AdvSmoothFillPreview3.Width := 65;
  AdvSmoothFillPreview3.Height := 65;
