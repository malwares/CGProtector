  ...
  begin
    ...
    begin
      case ComboBox1.ItemIndex of
        ...
        10: tmsif.SetComponentStyle(tsWindowsXP);
        12: tmsif.SetComponentStyle(tsWhidbey);
        13: tmsif.SetComponentStyle(tsWindowsVista);
        14: tmsif.SetComponentStyle(tsWindows7);
        15: tmsif.SetComponentStyle(tsTerminal);
      end;
    end;
  end;
end;
