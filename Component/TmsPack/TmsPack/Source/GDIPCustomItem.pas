...
uses
  ...
  GDIPPictureContainer, ImgList, Math;
...
type
  ...
  published
    ...
    property Position: TItemStatusPosition read FPosition write SetPosition default spItemRectangle;
  ...
  protected
    ...
    function GetFont(AItemAppearance: TItemAppearance): TFont;
