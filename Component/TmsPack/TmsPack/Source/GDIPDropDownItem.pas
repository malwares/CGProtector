...
type
  ...
  TDropDownItem = class(TImageTextButtonItem, IGDIPBase, ITMSStyle, IPictureContainerSupport)
  private
    time: cardinal;
    FContainer: TAdvPolyList;
...
begin
  ...
  FContainer.AutoSizeMode := asmControl;
  FContainer.AutoSizeType := astBoth;
