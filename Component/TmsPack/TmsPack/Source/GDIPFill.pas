...
function DrawGDIPText(graphics: TGPGraphics; Alignment: TAlignment; RF: TGPRectF; Caption:string; WideCaption: widestring; AFont: TFont; Enabled: Boolean; RealDraw: Boolean; AntiAlias: TAntiAlias; OutLineClr: TColor; Shadow: Boolean; ShadowClr: TColor): TGPRectF;
var
  w,h: Integer;
...
begin
  DrawGDIPText(g, taLeftJustify, FCapDesRect, CapacityDes, '', CapacityFont, True, True, aaAntiAlias, clWhite, True, CapacityTextShadowColor);
  DrawGDIPText(g, taLeftJustify, FCapFormatRect, DesFormat, '', CapacityFont, True, True, aaAntiAlias, clWhite, True, CapacityTextShadowColor);
end;
...
begin
  ...
  begin
    ...
    DrawGDIPText(g, taLeftJustify, Items[I].FDesRect, Items[I].Description, '', LegendFont, True, True, aaAntiAlias, clWhite, True, LegendTextShadowColor);
    DrawGDIPText(g, taLeftJustify, Items[I].FFormatRect, Items[I].LegendFormat, '', LegendFont, True, True, aaAntiAlias, clWhite, True, LegendTextShadowColor);
  end;
  DrawMark(FFreeMarkPT, Color, ColorTo{clWhite});
  DrawGDIPText(g, taLeftJustify, FFreeDesRect, FreeDes, '', LegendFont, True, True, aaAntiAlias, clWhite, True, LegendTextShadowColor);
  DrawGDIPText(g, taLeftJustify, FFreeFormatRect, FreeDesFormat, '', LegendFont, True, True, aaAntiAlias, clWhite, True, LegendTextShadowColor);
end;
