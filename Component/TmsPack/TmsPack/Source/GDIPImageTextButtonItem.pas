...
uses
  Windows, Graphics, Messages, Controls, Forms, AdvGDIP, Classes,
  GDIPCustomItem, GDIPImageTextItem, GDIPFill;
...
type
  TItemButtonType = (btButton, btExpander);
...
begin
  ...
  begin
    ...
    ir := MakeRect(r.X, r.Y, r.Width - ButtonWidth, r.Height);
