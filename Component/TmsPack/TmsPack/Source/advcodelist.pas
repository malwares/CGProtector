...
const
  ...
  BLD_VER = 0; // Build nr.
  DATE_VER = 'Apr, 2010'; // Month version
...
type
  ...
  protected
    ...
    procedure DrawItemEx(ACanvas: TCanvas; Index: Integer; Rect: TRect; State: TOwnerDrawState);
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        {$IFDEF TMSDOTNET}
        DrawText(bmp.Canvas.Handle, FCodeBlocks[itemID].Caption, Length(FCodeBlocks[itemID].Caption), rct1, DT_SINGLELINE or DT_LEFT);
        {$ENDIF}
        {$IFNDEF TMSDOTNET}
...
procedure TAdvCodeList.DrawItemEx(ACanvas: TCanvas; Index: Integer; Rect: TRect; State: TOwnerDrawState);
var
  allb: integer;
...
begin
  ...
  begin
    ...
    begin
      ...
      Images.Draw(ACanvas,Rect.Left + CodeIndent,Rect.Top +1 ,CodeBlocks[Index].ImageIndex);
    ...
    begin
      DrawCustomLine(ACanvas, Index, Subindex, FStyle, dmScreen, Rect);
    ...
    begin
      ...
      ACanvas.TextOut(Rect.Left, Rect.Top, '...');
    end;
  end
  else
  begin
