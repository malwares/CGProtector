...
{$ENDIF}
    ...
    property OnDropDownGetItemText
      : TGetCellTextEvent read FOnDropDownGetItemText write
      FOnDropDownGetItemText;
    property OnDropDownDrawItem: TDrawCellEvent read FOnDropDownDrawItem write
      FOnDropDownDrawItem;
    property OnDropDownGetItemProp
      : TGetCellPropEvent read FOnDropDownGetItemProp write
