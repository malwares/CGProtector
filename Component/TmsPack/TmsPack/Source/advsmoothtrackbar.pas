...
type
  ...
  TAdvSmoothTrackBarDrawNumber = procedure(Sender: TObject; value: Double; var s: String; var AllowDrawText: Boolean; var AllowDrawTickMark: Boolean) of object;
...
begin
  ...
  begin
    ...
    if Assigned(OnDrawNumber) then
      OnDrawNumber(Self, I * step + Minimum, s, alnum, altick);
    ...
    case Direction of
      ...
      begin
        ...
        if ShowTickMarks and altick then
        begin
          //draw tickmarks
