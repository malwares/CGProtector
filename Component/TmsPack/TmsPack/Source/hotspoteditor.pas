...
type
  ...
  TfrmHSIEditor = class(TForm)
    ...
    Shape_ClickColor: TPanel;
    Shape_HoverColor: TPanel;
    Shape_SelectedColor: TPanel;
    Shape_BlinkColor: TPanel;
...
begin
  ...
  begin
    ...
    begin
      ...
      HoverColor := GetPanelColor(Shape_HoverColor); // Pn_HoverColor.Color;
      ClickColor := GetPanelColor(Shape_ClickColor); //Pn_ClickColor.Color;
      SelectedColor := GetPanelColor(Shape_SelectedColor); //Pn_SelectedColor.Color;
      BlinkColor := GetPanelColor(Shape_BlinkColor); //Pn_BlinkColor.Color;
    ...
    begin
      ...
      SetPanelColor(Shape_HoverColor, HoverColor);
      Pn_ClickColor.Color := ClickColor;
      SetPanelColor(Shape_ClickColor, ClickColor);
      Pn_SelectedColor.Color := SelectedColor;
      SetPanelColor(Shape_SelectedColor, SelectedColor);
      Pn_BlinkColor.Color := BlinkColor;
      SetPanelColor(Shape_BlinkColor, BlinkColor);
...
begin
  ...
  begin
    ...
    SetPanelColor(Shape_BlinkColor, ColorDialog1.Color);
  end;
end;
...
begin
  ...
  begin
    ...
    SetPanelColor(Shape_HoverColor, ColorDialog1.Color);
  end;
end;
...
begin
  ...
  begin
    ...
    SetPanelColor(Shape_SelectedColor, ColorDialog1.Color);
  end;
end;
